																							...
																							<table width="100%" border="0" cellspacing="0" cellpadding="0">
																								<tr>
																									<td class="fluid-img img-center pb-50" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 50px;">
																										<img src="https://cdn-icons-png.flaticon.com/512/3634/3634820.png " width="282" height="300" editable="true" border="0" alt="" />
																									</td>
																								</tr>
																								<tr>
																								...
																								<tr>
																									<td class="title-36 a-center pb-35" style="font-size:36px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 35px;">
																										<multiline>
																											<strong>Atención para su mascota "{{$medical_record["name_pet"]}}"</strong>
																										</multiline>
																									</td>
																								</tr>
																								<tr>
																													...
																													<table width="100%" border="0" cellspacing="0" cellpadding="0">
																																...
																																<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: -90px;">
																																	<tr>
																																		<td class="img-center pb-20" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 20px;">
																																			<img src="{{$medical_record["imagen"]}}" width="110" height="110" editable="true" border="0" alt="" />
																																		</td>
																																	</tr>
																																</table>
																															</td>
																															...
																															<td class="text-18 a-center c-purple pb-15" style="font-size:18px; line-height:22px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; color:#9128df; padding-bottom: 15px;">
																																<multiline>
                                                                                                                                    @switch($medical_record["event_type"])
                                                                                                                                        @case(1)
                                                                                                                                            <strong>Cita Medica</strong>
                                                                                                                                            @break
                                                                                                                                        @case(2)
                                                                                                                                        <strong>Vacuna</strong>
                                                                                                                                        @break
                                                                                                                                        @case(3)
                                                                                                                                        <strong>Cirujía</strong>
                                                                                                                                        @break
                                                                                                                                        @default
																														...
																														<tr>
																															<td class="text-16 lh-26 a-center c-black" style="font-size:16px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; color:#282828;">
																																<multiline>
																																	<em>"Tiene programado unos de nuestro servicios para la fecha {{$medical_record["event_date"]}} a la hora {{$medical_record["hour_start"]}}"</em>
																																</multiline>
																															</td>
																														</tr>
																													</table>
